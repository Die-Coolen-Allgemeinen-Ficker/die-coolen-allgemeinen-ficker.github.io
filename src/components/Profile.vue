    ...
    methods: {
        getMinecraftUserName (uuid: string): Promise<string> {
            return new Promise((resolve, _) => {
                ...
                request.open('GET', `https://bcaf-api.onrender.com/v1/minecraft/name/${uuid}`);
        ...
        saveEdit () {
            ...
            const request = new XMLHttpRequest();
            request.open('POST', `https://bcaf-api.onrender.com/v1/accounts/lookup/${this.accountData.userId}`);
